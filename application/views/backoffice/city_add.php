...
<div class="page-container">
    ...
    <!-- END sidebar -->
    <?php
    if (isset($city_update) && $city_update != "") {
        $add_label    = $this->lang->line('edit') . ' City';
        $form_action      = base_url() . ADMIN_URL . "/" . $this->controller_name . "/update_city/" . $this->uri->segment('4');
    } else {
        $add_label    = $this->lang->line('add') . ' City';
        $form_action      = base_url() . ADMIN_URL . "/" . $this->controller_name . "/add_city/" . $this->uri->segment('4');
    }
    ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url() . ADMIN_URL . '/' . $this->controller_name ?>/city_view">City Area</a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <?php echo "Add City"; ?>
                            ...
                            <form action="<?php echo $form_action; ?>" id="form_add_<?php echo $this->prefix ?>" name="form_add_<?php echo $this->prefix ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="hidden" name="entity_id" id="entity_id" value="<?php echo ($city_update[0]['id'] ?
                                                                                                            $city_update[0]['id'] : '') ?>" />

                                            <input type="text" name="name" id="name" value="<?php echo ($city_update[0]['name'] ?
                                                                                                $city_update[0]['name'] : '') ?>" maxlength="249" data-required="1" class="form-control required" onchange="handleAction()" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-actions right">
                                    <a class="btn default" href="<?php echo base_url() . ADMIN_URL . '/' . $this->controller_name ?>/city_view"><?php echo $this->lang->line('cancel') ?></a>
