        ...
        <div class="col-md-12">
            <div class="portlet-body">
                <div class="table-responsive">
                    ...
                    <thead>
                            <tr>                            
                             <th><?php echo $this->lang->line("mail_merge_field_reciever"); ?></th>
                             <th><?php echo $this->lang->line("mail_merge_field_sender"); ?></th>
                             <th><?php echo $this->lang->line("replaced_field"); ?></th>
                         </tr>
                    </thead>
                    <tbody>
