...
/*.div_1{text-align:left;width:4%;float:left;padding:5px 0 5px 10px;}
.div_2{text-align:left;width:15%;float:left;padding:5px 0 5px 10px;}
...
.div_6{text-align:left;width:25%;float:left;padding:5px 0 5px 10px}*/
.b0{border-bottom: 0}
.width60{width: 60%}
.width15{width: 15%}
.width20{width: 20%}
	...
	<div class="segment-main">
        ...
        <div class="div-thead">
          	<div>
	            ...
	            <div style="text-align:left;width:20%;float:left;padding:5px 0 5px 10px;"><?php echo $this->lang->line("user_name"); ?></div>
	            <div style="text-align:center;width:15%;float:left;padding:5px 0 5px 0"><?php echo $this->lang->line("no_of_people"); ?></div>
	            <div style="text-align:center;width:15%;float:left;padding:5px 0 5px 0"><?php echo $this->lang->line("package"); ?></div>
	            <div style="text-align:center;width:15%;float:left;padding:5px 0 5px 0"><?php echo $this->lang->line("event_status"); ?></div>
	            <div style="text-align:center;width:20%;float:left;padding:5px 0 5px 0"><?php echo $this->lang->line("total"); ?></div>
            </div>
        </div>
        <!-- body -->
        <div>
            <div class="b0">
	            ...
	            <div style="text-align:left;width:20%;float:left;padding:5px 0 5px 10px"><?php echo (!empty($user_detail))?$user_detail['first_name'].' '.$user_detail['last_name']:''  ?></div>
	            ...
	            <div style="text-align:center;width:20%;float:left;padding:5px 0 5px 0" class="center"><?php echo number_format_unchanged_precision($event_records->subtotal,$event_records->currency_code); ?></div>
           </div>
        </div>
	</div>
