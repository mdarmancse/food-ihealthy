...
<div class="page-container">
    ...
    if ($this->input->post()) {
        ...
        $FieldsArray = array('content_id', 'entity_id', 'branch_entity_id', 'name', 'phone_number', 'email', 'address', 'landmark', 'latitude', 'longitude', 'country', 'city', 'zipcode', 'amount_type', 'created_by', 'amount', 'vat', 'sd', 'enable_hours', 'timings', 'break_timing', 'image', 'cover_image', 'price_range', 'is_veg', 'driver_commission', 'currency_id', 'restaurant_slug', 'commission', 'zonal_admin', 'status', 'price_value', 'delivery_time');
                            ...
                            <form action="<?php echo $form_action; ?>" id="form_add<?php echo $this->prefix; ?>" name="form_add<?php echo $this->prefix; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="branch_entity_id" class="form-control" id="branch_entity_id_select">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="country" id="country" value="<?php echo ($country ? $country : "Bangladesh"); ?>" maxlenght="40" />
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                                            ...
                                            <select class="form-control" name="currency_id" id="currency_id" <?php echo ($currency) ? "readonly " . $point : "" ?>>
                                                ...
                                                <?php if (!empty($currencies)) {
                                                    foreach ($currencies as $key => $value) { ?>
                                                        <option value="<?php echo $value['currency_id']; ?>" <?php echo (18 == $value['currency_id']) ? "selected" : "" ?>><?php echo $value['country_name'] . ' - ' . $value['currency_code']; ?></option>
                                                <?php }
                                                } ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="commission" id="commission" <?= ($this->session->userdata('UserType') == 'CentralAdmin') ? 'disabled="disabled"' : '' ?> value="<?php echo $commission ?>" maxlength="10" data-required="1" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <!-- <div class="form-group">
                                        <label class="control-label col-md-3"><?php //echo $this->lang->line('tax_amount');
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3"><?php //echo $this->lang->line('tax');
                                                                                ?><span class="required">*</span></label>
                                        <div class="col-sm-8 form-markup">
                                              <label id="Percentage"><?php //echo $this->lang->line('Percentage');
                                                                        ?> (%)</label>
                                              <label id="Amount" style="display:none" class="display-no"><?php //echo $this->lang->line('amount');
                                                                                                            ?> ($)</label>
                                              <br>
                                              <input type="text" name="amount" id="amount" value="<?php //echo ($amount)?$amount:'';
                                                                                                    ?>" maxlength="19" data-required="1" class="form-control"/>
                                        </div>
                                    </div> -->
                                    <div class="form-group display-no">
...
<script>
    ...
    $(document).ready(function() {
        $("#branch_entity_id_select, #admin_user, #zonal_admin").select2({

        });

        $("#branch_entity_id_select").change(function() {
            var val = $(this).val();

            $.ajax({
                type: 'POST',
                url: BASEURL + "<?php echo ADMIN_URL ?>/restaurant/getRestaurantNumber",
                data: {
                    'restaurant_id': val,
                },
                success: function(res) {
                    ...
                    $("#preview").removeClass('display-no');

                    $("#coverPreview").attr('src', data.cover_image);
                    $("#coverPreview").removeClass('display-no');
                },

                error: function(xhr) {
                    console.error("Couldn't fetch restaurant number");
                }
    ...
    var mapGeocoding = function() {
        var map = new GMaps({
            div: '#gmap_geocoding',
            lat: 22.359091474324057,
            lng: 91.82152204807325,
            click: function(e) {
