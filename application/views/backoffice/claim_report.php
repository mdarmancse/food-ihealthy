                                ...
                                <div style="overflow-x: auto;">
                                    <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="wrapper">
                                                <h4 align="center"><b><i>Claim Report</i></b></h4>
                                                <hr>
                                            </div>
                                            ...
                                            <div class="Data">
                                                ...
                                                <table id="claimList" class="table table-bordered table-striped table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>Sl</th>
                                                            <th>User ID</th>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#claimList').DataTable({
            ...
            'ajax': {
                'url': "<?php echo base_url() ?>backoffice/System_option/Claim_report",
                "data": function(data) {
            ...
            "footerCallback": function(row, data, start, end, display) {
                ...
                $(api.column(3).footer()).html(faTotal.toLocaleString(undefined, {
