...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/plugins/moment.min.js" />
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/plugins/datetime-moment.js" />
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/plugins/date-euro.js" />
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        Pre Order <?php echo $this->lang->line('list') ?>
                    </h3>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"> Pre Order <?php echo $this->lang->line('list') ?></div>
                            <div class="actions">
                        ...
                        $min = "";
                        $sql = "select OptionValue FROM system_option where OptionName = 'Preorder notification threshhold (minute)'";
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "fnRowCallback": function(nRow, aData) {
                    ...
                    var preorderDate = new Date(aData[7].replace(/(\d{2})-(\d{2})-(\d{4})/, "$2/$1/$3"));

                    var res = preorderDate - currentDate;

                    // document.write(s,"<br>");
                    var val = '<?php echo $min ?>';
                    var cal = Math.round((res / 1000) / 60);
                    // document.write("dvojv:",abc,"<br>");
                    if (cal < val) {
                        $('td', nRow).css('background-color', '#FF355E');

                    }
                },
                "bServerSide": true, // server side processing
                "sAjaxSource": "ajaxview/preorder", // ajax source
                "aaSorting": [
                    [7, "asc"]
                ],
                // "order": [
