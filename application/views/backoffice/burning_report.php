                                ...
                                <div style="overflow-x: auto;">
                                    <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="wrapper">
                                                <h4 align="center"><b><i>Burning Report</i></b></h4>
                                                <hr>
                                            </div>
                                            ...
                                            <div class="Data">
                                                ...
                                                <table id="BurnedVoucherList" class="table table-bordered table-striped table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>Sl</th>
                                                            <th>User ID</th>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#BurnedVoucherList').DataTable({
            ...
            'ajax': {
                'url': "<?php echo base_url() ?>backoffice/System_option/Burning_report",
                "data": function(data) {
