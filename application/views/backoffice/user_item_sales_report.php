                            ...
                            <div class="table-container">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="wrapper">
                                            <h4 align="padding-left"><b><i>Item Sales Report (User Wise)</i></b></h4>
                                        </div>
                                        ...
                                        <div class="Data">
                                            ...
                                            <form method="get" action="" target="_blank">
                                                <table class="formcontrols">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="customer_id" id="customer_id" class="restaurant" style="height: 30px;width: 200.59px">
                                                                <option value="">Select All</option>
                                                                <?php
                                            ...
                                            <div class="table-responsive" style="overflow:auto; width:100%">
                                                <table id="userItemSales" class="table table-striped table-bordered" style="display: none;">
                                                    <thead>
...
<script>
    $(document).ready(function() {
        ...
        $('#entity_id,#customer_id,#to_date,#from_date').change(function() {

            $('#userItemSales').DataTable().destroy(); //So that datatable reinitialize error cant accure.
            ...
            if (to_date && form_date) {
                ...
                $('#userItemSales').DataTable({
                    ...
                    "ajax": {
                        url: BASEURL + "backoffice/Report_template/showUserItemSales",
                        type: 'post',
                        data: {
                            'Res': res,
                            'Cus': cus,
