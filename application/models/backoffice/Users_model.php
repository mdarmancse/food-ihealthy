...
class Users_model extends CI_Model
{
    ...
    public function addrider($tblName, $Data)
    {
        $this->db->insert($tblName, $Data);
        return $this->db->insert_id();
    }
    ...
    {
        // $this->db->select('rider_information.id');
    ...
    //get items
    public function get_zone_by_city($entity_id)
    {
        //  echo "<pre>";
        //  print_r($entity_id);
        //  exit();
        $this->db->select('area_name,entity_id');
        $this->db->where('city_id', $entity_id);
    ...
    // update data common function
    public function updateRider($Data, $tblName, $fieldName, $ID)
    {
