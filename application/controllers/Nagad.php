        ...
        <!DOCTYPE html>
            <html>
                ...
                <body>
                    ...
                    <button onclick="myFunction()" id="showPopUp">Try it</button>
                    
                    <p id="demo"></p>
                
                    <script>
                    function myFunction() {
                      let callBackURL = "http://foodaani.com/gjc/Nagad/callbackUrl";
                      if (confirm("Pay 60 tk")) {
                               $.ajax({
                                      url: callBackURL,
                                      type: "POST",
                                      data: JSON.stringify({
                                          "amount" : 60,
                                          "invoice" : "dfuerhtiuhiu4jnifjg"
                                      }),
...
$merchantCallbackURL = "https://localhost:450/sandbox-master/merchant-callback-website";
...
if (isset($Result_Data['sensitiveData']) && isset($Result_Data['signature'])) {
    if ($Result_Data['sensitiveData'] != "" && $Result_Data['signature'] != "") {
        ...
        if (isset($PlainResponse['paymentReferenceId']) && isset($PlainResponse['challenge'])) {
            ...
            //echo json_encode($SensitiveDataOrder);
            //echo "<br>";
