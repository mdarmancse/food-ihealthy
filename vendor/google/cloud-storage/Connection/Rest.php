...
class Rest implements ConnectionInterface
{
    ...
    public function downloadObject(array $args = [])
    {
        ...
        return $this->requestWrapper->send(
            new Request('GET', Psr7\Utils::uriFor($uri)),
            $requestOptions
        )->getBody();
    }
    ...
    private function resolveUploadOptions(array $args)
    {
        ...
        $args['data'] = Psr7\Utils::streamFor($args['data']);
        ...
        if ($args['validate'] && !isset($args['metadata']['md5Hash'])) {
            $args['metadata']['md5Hash'] = base64_encode(Psr7\Utils::hash($args['data'], 'md5', true));
        }
        ...
        $args['contentType'] = isset($args['metadata']['contentType'])
            ...
            : Psr7\MimeType::fromFilename($args['metadata']['name']);
