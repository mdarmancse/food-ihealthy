			...
			var setIndexes = function ($items, groupName, repeaters) {
				$items.each(function (index) {
					...
					$filterNested($item.find("[name]"), repeaters).each(function () {
						...
						var name = matches
							? $input.attr("repeater-keep-full-name") ==
							  "on" /** This is for keeping the full name attribute as expected rather than replacing with only the last portion of name; Author: Mohammad Shoaib Elias (mishoel344@gmail.com) */
								? $input.attr("name")
						...
						var newName =
							...
							index +
							"]" +
							($input.attr("repeater-keep-full-name") == "on" ? "" : "[") +
							name +
							($input.attr("repeater-keep-full-name") == "on" ? "" : "]") +
